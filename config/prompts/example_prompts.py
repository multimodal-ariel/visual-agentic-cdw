...
- SynthSeg: CT and MRI (3D). Brain/head segmentation only; use for brain CT or brain MRI.
...
7. For brain CT or brain MRI: always include SynthSeg and VISTA3D (SynthSeg is the dedicated brain head tool; VISTA3D has detailed brain parcellation)
8. for qc_organs: include only the main organs of the anatomy. abdominal scans must show liver, kidney_left, kidney_right, spleen, pancreas and a few other major organs. A chest radiograph should show lung lobes and cardiac substructures. Brain CT/MRI should have brain.
